...
//        });
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/k2c_product?characterEncoding=utf8");
...
//        strategy.setTablePrefix(new String[] { "tlog_", "tsys_" });// 此处可以修改为您的表前缀
        ...
        strategy.setInclude(new String[] { "product_image_record" }); // 需要生成的表
