...
//    public static final String privateKeyTest = SecretKeyUtils.privateKeyTest;
//
//
...
//        context.setThirdPartyId(tpIdTest);
//        context.setClientPK("", privateKeyTest);
//        ApiAccessor apiAccessor = new ApiAccessor(context, 3000, 3000, urlTest);
//        return apiAccessor;
//    }
//
...
//    public void ssa(){
//
//        List<Api_LOGISTICSOPENAPI_YitSendLogisticsInfo> params = new ArrayList<>();
//        Api_LOGISTICSOPENAPI_YitSendLogisticsInfo info = new Api_LOGISTICSOPENAPI_YitSendLogisticsInfo();
//
//        //一条订单编号
//        info.subOrderNo = "11111126-0001";
//        //一条sku
//        info.itemId = 9448509;
//
//        //物流单号
//        info.logisticsCode = "1234567";
//        //物流公司
//        info.companyName = "DEBANG";
//        params.add(info);
//        LogisticsOpenApi_SendLogisticsByItemId sendLogisticsByItemId = new LogisticsOpenApi_SendLogisticsByItemId(params);
//
//        ApiContext context = ApiContext.getCurrent();
//        context.setThirdPartyId(tpIdTest);
//        context.setClientPK(SecretKeyUtils.publicKeyProduct, SecretKeyUtils.privateKeyProduct);
//        ApiAccessor apiAccessor = getApiAccessor();
//        ServerResponse serverResponse = apiAccessor.fillApiResponse(new BaseRequest<?>[]{sendLogisticsByItemId});
//
//        System.out.println("一条响应状态 {} "+JSON.toJSONString(serverResponse));
//        System.out.println("一条响应数据 {} "+ JSON.toJSONString(sendLogisticsByItemId.getResponse()));
//
//        Api_LOGISTICSOPENAPI_YitSendLogisticsResult response = sendLogisticsByItemId.getResponse();
